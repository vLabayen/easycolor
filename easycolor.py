def ec_internal_print(template, config, print_args = None):
...
def ecprint(texts, c = None, bg_c = None, template = None, print_args = None):
    ...
    print_args : dict with any valid keywork argument to the print function
        example : print_args = {"end":"...\\n"} to emulate print(template.format(*texts), end="...\\n")
    ...
    ec_internal_print(template, conf, print_args = print_args)
